...
//REFACTORY:Move to  AM_HomeScreenConfig End
    ...
    //
    static bool flashIsFull(void);      //REFACTORY: Move to AM_DeviceGlobal
    ...
    //
    inline static unsigned int getEZXUid(void);

    //
    // get "drm" user's UID, added by Gao Liangtao, 2004, 04/26
    //
    inline static unsigned int getDRMUid(void);
    inline static unsigned int getEZXGid(void);
